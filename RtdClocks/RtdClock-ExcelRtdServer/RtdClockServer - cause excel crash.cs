    ...
    public class RtdClockServer : ExcelRtdServer
    {
        ...
        private async void getCtpticks()
        {
            ...
            stockTickerHubProxy.On<Future>("UpdateFuturePrice", future =>
            {
                ...
                //    //}
                //}
                //TODO: bellow section will cause update slow on vs debug.
                ...
                foreach (var topic in topicsForSymbol)
                {
                    ...
                    //if (topic._type == "Open" && Convert.ToDecimal(topic.Value) != future.OpenPrice)
                    //{
                    //    topic.UpdateValue(future.OpenPrice);
                    //}
                    //if (topic._type == "High" && Convert.ToDecimal(topic.Value) != future.HighestPrice)
                    //{
                    //    topic.UpdateValue(future.HighestPrice);
                    //}
                    //if (topic._type == "Low" && Convert.ToDecimal(topic.Value) != future.LowestPrice)
                    //{
                    //    topic.UpdateValue(future.LowestPrice);
                    //}
